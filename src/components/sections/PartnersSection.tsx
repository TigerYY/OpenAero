...
const partners = [
  {
    nameKey: 'dji.name',
    logo: 'DJI',
    descriptionKey: 'dji.description',
    categoryKey: 'categories.tech',
  ...
  },
  {
    nameKey: 'huawei.name',
    logo: 'HUAWEI',
    descriptionKey: 'huawei.description',
    categoryKey: 'categories.cloud',
    color: 'bg-gradient-to-br from-red-500 to-red-700',
    textColor: 'text-white',
  },
  {
    nameKey: 'alibaba.name',
    logo: 'ALIBABA',
    descriptionKey: 'alibaba.description',
    categoryKey: 'categories.cloud',
    color: 'bg-gradient-to-br from-orange-400 to-orange-600',
    textColor: 'text-white',
  },
  {
    nameKey: 'thunder.name',
    logo: 'THUNDER',
    descriptionKey: 'thunder.description',
    categoryKey: 'categories.tech',
